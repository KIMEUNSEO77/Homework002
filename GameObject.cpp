...
XMFLOAT3 CEnemyObject::GetMoveToPlayerVector(XMFLOAT3 xmf3PlayerPosition, float fTimeElapsed)
{
	...
	XMFLOAT3 xmf3Direction = XMFLOAT3(xmf3PlayerPosition.x - xmf3Position.x, 0.0f, xmf3PlayerPosition.z - xmf3Position.z);

	float fLength = sqrtf(xmf3Direction.x * xmf3Direction.x + xmf3Direction.z * xmf3Direction.z);
	...
	return XMFLOAT3(xmf3Direction.x * m_fMoveSpeed * fTimeElapsed, 0.0f, xmf3Direction.z * m_fMoveSpeed * fTimeElapsed);
}
